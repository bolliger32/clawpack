...
# -*- coding: utf-8 -*-
#
# geoclaw documentation build configuration file, created by
...
extlinks = {
    'issue': ('https://github.com/bolliger32/geoclaw/issues/%s', 'GH #'),
    'pull': ('https://github.com/bolliger32/geoclaw/pull/%s', 'PR #')}
...
version = str(geoclaw.version)
# The full version, including alpha/beta/rc tags.
release = str(geoclaw.version)
